...
Current state: **v0.2.1 corrective demotion state - deterministic scaffold; no real AI layer, full frontend, real municipal data/search, migrations, or public-use gate. The previous v1.0.0 release was published in error and is superseded by this honest sub-1.0.0 label.** CivicPlan remains aligned to the CivicCore v1.1.0 release wheel. CivicPlan does not ship official planning determinations, legal advice, live external vendor calls by default, permitting-system write-back, or elected-body decisions.
