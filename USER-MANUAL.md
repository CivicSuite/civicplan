...
Current state: `0.1.1` planning policy foundation release plus production-depth policy persistence slice. The module includes deterministic sample checks, optional database-backed policy and staff-analysis records, `civiccore==1.0.0` alignment, and a public sample UI at `/civicplan`. It does not provide legal advice, official planning determinations, live GIS, live LLM calls, plan document ingestion, permitting-system integrations, or final staff-report approval.
